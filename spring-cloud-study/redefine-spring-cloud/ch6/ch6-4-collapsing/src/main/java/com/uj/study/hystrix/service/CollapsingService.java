...
import static com.netflix.hystrix.HystrixCollapser.Scope.*;

/**
 * @author ：UncleJet
 * @date ：Created in 2021/5/21 上午9:48
 * @description：
 */
@Component
public class CollapsingService implements ICollapsingService{
    ...
    @HystrixCollapser(batchMethod = "collapsingListGlobal",scope = GLOBAL, collapserProperties = {
