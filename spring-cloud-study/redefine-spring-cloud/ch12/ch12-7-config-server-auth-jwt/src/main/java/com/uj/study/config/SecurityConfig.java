...
import com.uj.study.security.JwtAuthenticationEntryPoint;
import com.uj.study.security.WebAuthenticationDetailsSourceImpl;
import com.uj.study.security.filter.JwtAuthenticationTokenFilter;
...
/**
 * @author ：UncleJet
 * @date ：Created in 2021/9/2 上午9:44
 * @description：
 */
@Configuration
@EnableWebSecurity
